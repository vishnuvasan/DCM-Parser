...
foreach my $key (keys(%Distribution_Details))
{
	print "\n Distribution 	: $key \n";
	print " Size		: $Distribution_Details{$key}{'SIZE'} \n ";
	print " Description	: $Distribution_Details{$key}{'DESCRIPTION'} \n ";
	print " Function	: $Distribution_Details{$key}{'FUNCTION'} \n ";
	print " Unit		: $Distribution_Details{$key}{'UNIT'} \n ";
	print " XAxis Varbl	: $Distribution_Details{$key}{'X-AXIS-VARIABLE'} \n ";
	print " X Axis Unit	: $Distribution_Details{$key}{'X-AXIS-UNIT'} \n ";
	print " X Axis Value : $Distribution_Details{$key}{'X-AXIS-VALUE'}\n\n\n";
	print " Array Value : $Distribution_Details{$key}{'VALUE'}\n\n\n";
}
